...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { dates: @employer.dates, description: @employer.description, image: @employer.image, name: @employer.name, rank: @employer.rank }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { dates: @employer.dates, description: @employer.description, image: @employer.image, name: @employer.name, rank: @employer.rank }
    assert_redirected_to employer_path(assigns(:employer))
  end
